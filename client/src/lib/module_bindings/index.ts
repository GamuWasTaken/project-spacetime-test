...
import MessagePositionRow from "./message_position_table";
...
const tablesSchema = __schema({
  cursor: __table({
    name: 'cursor',
    indexes: [
      { accessor: 'id', name: 'cursor_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'cursor_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, CursorRow),
  message: __table({
    name: 'message',
  ...
  message_position: __table({
    name: 'message_position',
    indexes: [
      { accessor: 'id', name: 'message_position_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'message_position_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, MessagePositionRow),
});
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("update_message_position", UpdateMessagePositionReducer),
